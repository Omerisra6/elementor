...
import { applyOverridableWrappersToElements } from '../apply-overridable-wrappers-to-elements';

describe( 'applyOverridableWrappersToElements', () => {
	it( 'should wrap matching element settings with $$type overridable', () => {
		...
		// Act
		applyOverridableWrappersToElements( elements, overridableProps );
